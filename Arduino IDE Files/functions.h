...
//=========================================================================================================================================================================
    if(var == "LEDonoff")                                // Used To check whether the key extracted from the payload is equal to the string. If it is, then the code within the curly braces is executed.
    {
      LEDonoff = false;                                  // Used To set the relay off variable to false by default. This variable is used to track whether the relay is turned on or off.
      if(val == "ON") LEDonoff = true;                   // Used To check whether the value extracted from the payload is equal to the string "ON". If it is, then the relay variable is set to true, indicating that the relay should be turned on.
    }
  }
}